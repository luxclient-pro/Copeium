...
import cope.client.util.ListMode;
...
public class ContainerAction extends BetterModule {
    ...
    private final Setting<SettingColor> sideColor = sgRender.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(122, 137, 190, 127))
        .visible(render::get)
        .build()
    );
    ...
    private final Setting<SettingColor> lineColor = sgRender.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(122, 137, 190))
        .visible(render::get)
        .build()
    );
    ...
    public ContainerAction() {
        super(Cope.CATEGORY, "container-action", "Can throw out all items in containers or filterout some.");
    }
    ...
    private void onInventory(InventoryEvent event) {
        ...
        if (throwItems.get() && throwDirection.get() != ThrowDirection.FORWARDS)
            sendPacket(new PlayerMoveC2SPacket.LookAndOnGround(rot.x, rot.y, mc.player.isOnGround(), true));
